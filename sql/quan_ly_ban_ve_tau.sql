...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th1 02, 2026 lúc 07:44 AM
...
--
CREATE
DATABASE IF NOT EXISTS `quan_ly_ban_ve_tau` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE
`quan_ly_ban_ve_tau`;
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `sp_ThongKeDoanhSoNhanVien` (IN `p_thang` INT, IN `p_nam` INT)
BEGIN
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `sp_ThongKeDoanhThuTheoNgay` (IN `p_ngay_bat_dau` DATE, IN `p_ngay_ket_thuc` DATE)
BEGIN
SELECT
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `sp_ThongKeDoanhThuTheoTuyen` (IN `p_ngay_bat_dau` DATE, IN `p_ngay_ket_thuc` DATE)
BEGIN
SELECT td.ten_tuyen,
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `sp_ThongKeKhachHangVIP` (IN `p_limit` INT)
BEGIN
SELECT kh.ho_ten,
       kh.sdt,
...
CREATE
DEFINER=`root`@`localhost` PROCEDURE `sp_ThongKeTyLeLapDay` (IN `p_ngay_bat_dau` DATE, IN `p_ngay_ket_thuc` DATE)
BEGIN
...
(
    20
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: HN, DN, SG',
    `ten_ga` varchar
(
    100
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: Ga Hà Nội',
    `dia_chi` varchar
(
    255
...
INSERT INTO `ga_tau` (`id`, `ma_ga`, `ten_ga`, `dia_chi`, `thanh_pho`)
VALUES (1, 'HN', 'Ga Hà Nội', '120 Lê Duẩn', 'Hà Nội'),
...
(
    10
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: A1, B2',
    `id_toa_tau` int NOT NULL,
    PRIMARY KEY
(
    `id`
),
    UNIQUE KEY `unique_ghe_trong_toa`
(
    `so_ghe`,
    `id_toa_tau`
),
...
INSERT INTO `ghe` (`id`, `so_ghe`, `id_toa_tau`)
VALUES (1, 'A1', 1),
       (13, 'A1', 4),
       (2, 'A2', 1),
       (14, 'A2', 4),
...
INSERT INTO `khach_hang` (`id`, `cccd`, `ho_ten`, `ngay_sinh`, `gioi_tinh`, `sdt`, `dia_chi`)
VALUES (1, '001090000001', 'Phạm Văn Minh', '1990-05-12', 'Nam', '0912111222', 'Số 5, Ngõ 1, Quan Hoa, Hà Nội'),
...
(
    ...
    UNIQUE KEY `unique_tau_schedule`
(
    `id_tau`,
    `ngay_di`
),
    UNIQUE KEY `ma_lich_trinh`
(
    `ma_lich_trinh`
),
    KEY `id_tuyen_duong`
...
INSERT INTO `lich_trinh` (`id`, `ma_lich_trinh`, `id_tau`, `id_tuyen_duong`, `ngay_di`, `ngay_den`, `trang_thai`)
VALUES (1, 'LT-TET-01', 1, 1, '2025-01-20 06:00:00', '2025-01-21 12:00:00', 'Hoàn thành'),
...
(
    50
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: Ngồi mềm điều hòa, Giường nằm',
    `he_so_gia` decimal
(
    3,
    2
...
INSERT INTO `loai_toa` (`id`, `ten_loai`, `he_so_gia`)
VALUES (1, 'Ngồi cứng', 1.00),
...
INSERT INTO `nhan_vien` (`id`, `ma_nhan_vien`, `mat_khau`, `ho_ten`, `ngay_sinh`, `gioi_tinh`, `sdt`, `email`,
                         `dia_chi`, `vai_tro`)
VALUES (1, 'ADMIN01', '$2a$12$gmkjs/CePmv8B6L684vWD.ytns6H4aoo4EXuFcVMAfWD1iV586QzW', 'Nguyễn Quốc Hưng', '1980-05-15',
        'Nam', '0909123456', 'hung.nguyen@tauhoa.vn', 'Số 10, Đội Cấn, Ba Đình, Hà Nội', 'Quản trị viên'),
       (2, 'ADMIN02', '$2a$12$JriS6Fh3iYVWC2APBzOmju8X9/6V/z6TTjWSi9w2QS3h0f037.wL6', 'Trần Thị Thanh Tâm',
        '1985-08-20', 'Nữ', '0909234567', 'tam.tran@tauhoa.vn', '15 Lê Lợi, Hải Châu, Đà Nẵng', 'Quản trị viên'),
       (3, 'ADMIN03', '$2a$12$2nMQzv/tJzBU804t5tJ3MOj.EWhAGynFs7vuDT5KNgNENxz1yWMXu', 'Lê Văn Tuân', '1990-12-10',
        'Nam', '0909345678', 'tuan.le@tauhoa.vn', '120 Nguyễn Thị Minh Khai, Q3, TP.HCM', 'Quản trị viên'),
       (4, 'ADMIN04', '$2a$12$bEKMSlItzcpnDzDyqxx5G.uvj4vxAQnpwE2i.mQAAccOPA2iZ6k7a', 'Phạm Minh Hoàng', '1982-03-25',
        'Nam', '0909456789', 'hoang.pham@tauhoa.vn', 'TP. Thủ Đức, TP.HCM', 'Quản trị viên'),
       (5, 'ADMIN05', '$2a$12$n3oI8f3gurpnlkS1KhAZcu98h7If0B0m7NRAPVDHo10BvIGrj5qHa', 'Hoàng Thu Thảo', '1995-06-30',
        'Nữ', '0909567890', 'thao.hoang@tauhoa.vn', 'Cầu Giấy, Hà Nội', 'Quản trị viên'),
       (6, 'NV01', '$2a$12$WS1mox8/ujPzoAsNGQ8S5OfsBt1FqG6TrqMQABvnx2vIiYEbcoto6', 'Vũ Thị Thu Ngân', '1998-04-26',
        'Nữ', '0909678901', 'ngan.vu@tauhoa.vn', 'Thanh Khê, Đà Nẵng', 'Nhân viên'),
       (7, 'NV02', '$2a$12$RQ1t6qizqBDzPokkJxpfLucu2i6M0SEjcP5UNiNlonXRWG1geAaNy', 'Ngô Xuân Bách', '1993-09-15', 'Nam',
        '0909789012', 'bach.ngo@tauhoa.vn', 'Gò Vấp, TP.HCM', 'Nhân viên'),
       (8, 'NV03', '$2a$12$u1h7j1s6ATb8Du0STcvZk.8VuA7KSMqeQzUWbnR2NdR34Jz.kKqhO', 'Đặng Tuyết Mai', '2000-01-20', 'Nữ',
        '0909890123', 'mai.dang@tauhoa.vn', 'Long Biên, Hà Nội', 'Nhân viên'),
       (9, 'NV04', '$2a$12$P5B4Z/I5UzrsG85YT9y8vutqhU3AI.leimQYQFa99tCAMrYMWezZ6', 'Bùi Minh Tú', '2001-11-27', 'Nam',
        '0909901234', 'tu.bui@tauhoa.vn', 'TP. Vinh, Nghệ An', 'Nhân viên');
...
(
    20
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: SE1, TN1',
    `ten_tau` varchar
(
    100
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: Tàu Thống Nhất SE1',
    PRIMARY KEY
(
    `id`
),
...
INSERT INTO `tau` (`id`, `ma_tau`, `ten_tau`)
VALUES (1, 'SE1', 'Thống Nhất SE1 (Nhanh)'),
...
(
    20
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: Toa 1, Toa 2',
    `id_tau` int NOT NULL,
...
(
    ...
    UNIQUE KEY `unique_toa_trong_tau`
(
    `ma_toa`,
    `id_tau`
),
...
INSERT INTO `toa_tau` (`id`, `ma_toa`, `id_tau`, `id_loai_toa`)
VALUES (1, 'Toa 1', 1, 2),
       (2, 'Toa 2', 1, 3),
       (3, 'Toa 3', 1, 4),
       (4, 'Toa 1', 2, 2),
...
(
    20
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'VD: HN-SG',
    `ten_tuyen` varchar
(
    100
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(
    10,
    2
) NOT NULL COMMENT 'Giá gốc chưa nhân hệ số',
    PRIMARY KEY
(
    `id`
),
...
INSERT INTO `tuyen_duong` (`id`, `ma_tuyen`, `ten_tuyen`, `id_ga_di`, `id_ga_den`, `khoang_cach_km`, `gia_co_ban`)
VALUES (1, 'HN-SG', 'Hà Nội - Sài Gòn', 1, 3, 1726, 1000000.00),
...
INSERT INTO `ve_tau` (`id`, `ma_ve`, `id_khach_hang`, `id_lich_trinh`, `id_ghe`, `id_nhan_vien`, `ngay_dat`, `gia_ve`,
                      `trang_thai`)
VALUES (1, 'VE-01-01', 1, 1, 1, 6, '2025-01-10 08:00:00', 1200000.00, 'Đã thanh toán'),
...
--
-- Ràng buộc cho bảng `tuyen_duong`
--
