...
public class TKKhachHangPanel extends BasePanel{
    ...
    protected void initComponents(){
        ...
        JLabel labelTitle = new JLabel("Danh sách Khách hàng");
        ...
        panelForm.add(createInputField("CCCD/ Họ tên", fieldTuKhoa, Color.WHITE));
        ...
        TitledBorder tableBorder = new TitledBorder(new LineBorder(Color.LIGHT_GRAY), "Danh sách Khách hàng",
